...
const SuccessStories = () => {
  const { t } = useI18n();
  return (
    <section id="success" className="py-20 overflow-hidden bg-gradient-to-b from-blue-900/5 to-white dark:from-blue-900/5 dark:to-background">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2 text-sm">
                      <MapPin className="w-4 h-4 text-[#2A327A] dark:text-blue-300" />
                      <span className="text-muted-foreground">{story.location}</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                      <Clock className="w-4 h-4 text-[#FF9700] dark:text-orange-400" />
                      <span className="text-muted-foreground">{t("stories.resolved_in")} {story.timeframe}</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                      <CheckCircle className="w-4 h-4 text-[#13851B] dark:text-green-400" />
